<template>
  <div>
    <div class="search primary-padding" v-if="!mobileWidth">
    ...
    <div class="search search__mobile" v-if="mobileWidth">
      ...
      >
        ...
        <div class="search__mobileoverlaycontent" v-if="showFilter">
          <div class="search__mobileoverlaymid">
